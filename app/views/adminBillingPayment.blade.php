...
<div class="row">
              <div class="col s12 left">
                <ul class="tabs">
                  <li class="tab col s3"><a href="#customerOrder">Customer Order</a></li>
                  <li class="tab col s3"><a href="#materialsPurchasing">Materials Purchasing</a></li>
                </ul>
              </div>
  </div>
	...
	<div class = "row" style="margin:20px;">
		<div class = "col s6 m6 l6" style="background:white; padding:40px;  border:8px outset #00b0ff;">
	  	...
	  	<div class = "col s6 m6 l6" style="background:white; padding-left:42px; padding-right:42px; border:8px inset #ff5252;">
  			...
  			<div class="col s12">
		  			<div class="divider" style="background-color:red; margin-top:7px;"></div>
		  	</div>
  			<div class="input-field col s12" style="padding-left:300px">
