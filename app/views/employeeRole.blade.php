...
@section('content')
  ...
  <div class="main-wrapper">
    ...
    <div class="row">
      ...
      <button style="color:black" class="modal-trigger btn tooltipped btn-small center-text light-green accent-1" data-position="bottom" data-delay="50" data-tooltip="CLick to view deactivated roles from the table" href="#modal1">VIEW INACTIVE ROLES</button>
      </div>
    </div>
  </div>
