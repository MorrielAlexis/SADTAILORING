      ...
      <nav id="slide-out" class="side-nav fixed" style="position fixed; top: 0; padding-top:0px; margin-top:0px; background: #26A69A"> 
        <ul id="ul">
          ...
          <div class="col s12 center">
            ...
            <a class="btn-flat dropdown-button waves-effect waves-light profile-btn" href="#" data-activates="profile-dropdown"><span class="user" style="color:white; padding-bottom:5px"><b>{{Session::get('strEmpFName')}} {{Session::get('strEmpLName')}}<b></span></a>
          </div>
                ...
                <div class = "collapsible-body" position = "fixed" style = "display:block;">
                  <ul>
                    <li class = "no padding">
                      ...
                      <ul class = "collapsible collapsible-accordion">
                        <li class="bold"><a style="color:#212121; opacity:0.90" class="collapsible-header waves-effect waves-white" href= "{{URL::to('transaction/billing')}}"><font size = "-1"><b>Billing and Collection</b></font></a><li>
                      </ul>
                    </li>
                  </ul>
                </div>
