...
<h3 style="margin-bottom:20px; margin-left:20px;">Inactive Datas</h3>
  ...
  <div style="padding:20px">
      ...
      <ul class="tabs transparent" style="float:left">
        <li style="background:pink; border-top-left-radius: 20px; border-top-right-radius: 40px;" class="tab"><a style="color:black" href="#tabCustp">Customer</a></li>
        <li style="background:lightblue; border-top-left-radius: 20px; border-top-right-radius: 40px;" class="tab"><a style="color:black" href="#tabEmp">Employee</a></li>
    ...
    <div id="tabCustp" class="hue col s12" style="margin-top:45px; background-color: pink;">
    ...
    <div id="tabEmp" class="hue col s12" style="margin-top:45px; background-color: lightblue;">
    <div style="height:30px;"></div>
    ...
    <div id="tabGarm" class="hue col s12" style="margin-top:45px; background-color: lightgreen;">
    <div style="height:30px;"></div>
    ...
    <div id="tabFabmat" class="hue col s12" style="margin-top:45px; background-color: salmon;">
    <div style="height:30px;"></div>
    ...
    <div id="tabMate" class="hue col s12" style="margin-top:45px; background-color: seagreen;">
    <div style="height:30px;"></div>
