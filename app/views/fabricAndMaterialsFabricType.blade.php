  ...
  <div class="main-wrapper">  <!-- Main Wrapper  -->   
    ...
    <div class="row">
      <div class="col s12 m12 l12">
        ...
        <button style="color:black" class="modal-trigger btn tooltipped btn-small center-text light-green accent-1" data-position="bottom" data-delay="50" data-tooltip="Click to view deactivated fabric types from the table" href="#inactiveFabric">VIEW INACTIVE FABRICS</button>
      </div>
    </div>
